...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title> {{ __('core.panel.tpl.index.title') }} </title>
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading">{{ __('core.panel.tpl.index.intro') }}</h1>
                            <p class="intro-text">{{ __('core.panel.tpl.index.intro_text_1') }}
                                <br>{{ __('core.panel.tpl.index.intro_text_2') }}</p>
        ...
        <section id="about" class="container content-section text-center">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>{{ __('core.panel.tpl.index.about_section') }}</h2>
                    <p>{{ __('core.panel.tpl.index.about_section_text_1') }}</p>
                    <p>{{ __('core.panel.tpl.index.about_section_text_2') }}</p>
                    <p>{{ __('core.panel.tpl.index.about_section_text_3') }}</p>
                </div>
            </div>
        </section>
        <section id="download" class="content-section text-center">
            <div class="download-section">
                <div class="container">
                    <div class="col-lg-8 col-lg-offset-2">
                        <h2>{{ __('core.panel.tpl.index.download_section') }}</h2>
                        <p>{{ __('core.panel.tpl.index.download_section_text_1') }}</p>
                        <a href="http://startbootstrap.com/template-overviews/grayscale/" class="btn btn-default btn-lg">{{ __('core.panel.tpl.index.download_section_button') }}</a>
                    </div>
                </div>
            </div>
        </section>
        <section id="contact" class="container content-section text-center">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>{{ __('core.panel.tpl.index.contact_section') }}</h2>
                    <p>{{ __('core.panel.tpl.index.contact_section_text_1') }}</p>
                    <p><a href="mailto:{{ __('core.panel.tpl.index.contact_section_en_email') }} ">{{ __('core.panel.tpl.index.contact_section_en_email') }}</a>
                    </p>
