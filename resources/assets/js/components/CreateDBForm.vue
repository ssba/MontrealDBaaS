        ...
        methods: {
            ...
            CreateNewDBonSubmit_Event: function (event) {
                ...
                .then(function (response) {
                    ...
                    formValues.push("" +
                        "<a class='ctrlPanel' title='" + response.data.translates.getAllDBs_delete_db + "' id='deleteDB' href='#' data-toggle='modal' data-target='#confirm-delete' data-href='" + response.data.urls.deleteDB + "'><i class='fa fa-trash'></i></a> " +
                        "<a class='ctrlPanel' title='" + response.data.translates.getAllDBs_edit_db + "' id='editDB' href='" + response.data.urls.editDB + "'><i class='fa fa-pencil-square'></i></a> " +
