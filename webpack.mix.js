...
mix.js('resources/assets/js/views/admin.table.all.js', 'public/js/alltables.js')
    .sass('resources/assets/sass/AdminLTE/admin.table.all.scss', 'public/css/alltables.css');
